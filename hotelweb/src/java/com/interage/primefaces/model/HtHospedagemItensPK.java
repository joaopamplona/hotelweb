 ...
 */
@Embeddable
public class HtHospedagemItensPK implements Serializable {
    ...
    public HtHospedagemItensPK() {
    }

    public HtHospedagemItensPK(int codHospedagem, int nritem) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HtHospedagemItensPK)) {
            return false;
        }
        HtHospedagemItensPK other = (HtHospedagemItensPK) object;
    ...
    public String toString() {
        return "com.integare.bincontrole.HtHospedagemItensPK[ codHospedagem=" + codHospedagem + ", nritem=" + nritem + " ]";
    }
