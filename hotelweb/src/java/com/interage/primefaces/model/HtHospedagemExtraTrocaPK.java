 ...
 */
@Embeddable
public class HtHospedagemExtraTrocaPK implements Serializable {
    ...
    public HtHospedagemExtraTrocaPK() {
    }

    public HtHospedagemExtraTrocaPK(int codReservaExtra, int nritem) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HtHospedagemExtraTrocaPK)) {
            return false;
        }
        HtHospedagemExtraTrocaPK other = (HtHospedagemExtraTrocaPK) object;
    ...
    public String toString() {
        return "com.integare.bincontrole.HtHospedagemExtraTrocaPK[ codReservaExtra=" + codReservaExtra + ", nritem=" + nritem + " ]";
    }
